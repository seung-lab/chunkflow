...
@click.option('--output_chunk_start', type=int, help="the start coordinates of final output block",
              cls=PythonLiteralOption, default=[0,0,0])
...
@click.option('--gpu_ids', type=int, help="ids of gpus to use",
              cls=PythonLiteralOption, default=None)
@click.option('--framework', type=str, 
              help="backend of deep learning framework, such as pytorch and pznet.",
              default='pytorch')
@click.option('--output_channels', type=int, 
              help="number of convnet output channels", default=3)
