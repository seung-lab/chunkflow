...
def execute(synapses: Synapses, seg: Chunk):
    ...
    if len(tbars) == 0:
        print('tbars with 0 element: ', seg.bbox.string)
        return

    if seg.bbox.string == '0-1024_3072-4096_4096-5120':
        return

    # if seg.bbox.string == '0-1024_5120-6144_3072-4096':
    #     breakpoint()
    ...
    fname = os.path.join(file_path, f'{seg.bbox.string}.h5')
